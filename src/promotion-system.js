...
const PROMOTION_STEPS = Object.freeze([
  {
    from: '1 | NEW KILLA',
    to: '2 | KILLA',
    requirements: ['500 дерева', '1 день актива в корпорации'],
  },
  {
    from: '2 | KILLA',
    to: '3 | OLD KILLA',
    requirements: ['1200 дерева', '2 дня актива в корпорации'],
  },
  {
    from: '3 | OLD KILLA',
    to: '4 | MATCHER',
    requirements: ['2200 дерева', '3 дня актива в корпорации'],
  },
  {
    from: '4 | MATCHER',
    to: '5 | ORION',
    requirements: ['3500 дерева', '5 дней актива в корпорации'],
  },
  {
    from: '5 | ORION',
    to: '6 | RAVEN',
    requirements: ['5000 дерева', '7 дней актива в корпорации'],
  },
]);
...
export function buildPromotionReportFormEmbed() {
  return new EmbedBuilder()
    ...
    .setDescription([
      ...
      '🪵 Сколько дерева собрал',
      '',
      'Администрация сама проверит активность и количество ресурсов.',
    ].join('\n'))
...
function buildPromotionSystemDescription() {
  return [
    'Основное направление корпорации - дерево. Повышение до 6 ранга идёт через сдачу дерева и активность в корпорации.',
    '',
    ...
    '',
    '**📌 Важно**',
    '• В отчёте указывай только количество собранного дерева.',
    '• Повышение могут отклонить, если не хватает дерева или актива.',
    '• Администрация сама проверяет и считает активность.',
  ].join('\n');
}
